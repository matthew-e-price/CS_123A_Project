...
def perform_msa(input_file, output_file):
    clustalomega_cline = ClustalOmegaCommandline(infile=input_file, outfile=output_file, verbose=True, auto=True, cmd="/Users/ruchadeo/Downloads/clustalo")
...
input_sequences_file = '/Users/ruchadeo/Downloads/sampleseq.fasta.txt'
aligned_sequences_file = '/Users/ruchadeo/Downloads/outseq7.txt'
